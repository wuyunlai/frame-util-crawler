...
//	&& href.startsWith("http://www.ics.uci.edu/");
	&& href.startsWith("http://news.baidu.com");
//	&& href.startsWith("http://girlsluntan.net/thread-htm-fid-51-page-2.html");
	}
	...
	*/
	...
	public void visit(Page page) {
		...
		if (page.getParseData() instanceof HtmlParseData) {
			...
			for(;it.hasNext();){
				WebURL webURL = (WebURL) it.next();
				System.out.println("URL: " + webURL.getURL() + "---DEPTH: " + webURL.getDepth());
			}
		}
	}
}